---
title: 'mxnet example 3 : PapSmear 2005'
output:
  html_document:
    df_print: paged
---
...
list.classes <- list(class1_mat, class2_mat, class3_mat, class4_mat, class5_mat, class6_mat, class7_mat)
...
list_smp <- merge_train_test(list.classes, n_test= 5)
...
model <- mx.model.FeedForward.create(symbol = NN_model,       # The network schema
                                     ...
                                     ctx = devices,
                                     num.round = 150,
                                     array.batch.size = 20,  # The batch size used for R array training
                                     learning.rate = 0.02,
                                     momentum = 0.9,
                                     optimizer = "sgd",
...
selected_vec <- names(test_y[test_y==7])
